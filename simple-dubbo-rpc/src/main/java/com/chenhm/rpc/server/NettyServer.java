package com.chenhm.rpc.server;

import com.chenhm.base.util.NetUtils;
import com.chenhm.rpc.handler.NettyServerHandler;
...
public class NettyServer {
    ...
    public void run() throws Exception {
        ...
        try {
             ...
             * 然后提取这些匿名类到最顶层的类上。
             */
            b = b.childHandler(new ChannelInitializer() {
            ...
            log.info("netty server start, the host = {}", localhost + ":" + port);
            /**
             * 这里会一直等待，直到socket被关闭
             */
